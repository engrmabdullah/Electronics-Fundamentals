...
for (const f of files) {
  ...
  /* عنوان الدرس (title/data-title) يجب أن يحمل الاسم العلمي لا وصفًا.
     قائمة أوصاف رُصدت وطُلب استبدالها بالاسم العلمي. */
  const titleM = html.match(/<title>([^<]*)<\/title>/);
  const titleTxt = titleM ? titleM[1] : '';
  const DESC_TITLES = [
    'الدفع والجريان', 'الطريق المغلق', 'طريق واحد أم طريقان', 'العلاقة بين الثلاثة',
    'ما الذي يُبطئ', 'الطريق باتجاه واحد', 'الخزّان الصغير', 'حبّة فيها مدينة',
    'لمسة صغيرة', 'مفتاح تضغطه الكهرباء', 'كيف تصير الكهرباء صوتًا',
    'من يُشعل', 'من يخبر', 'كيف يطير', 'مفتوح أم مغلق', 'بين المفتوح',
    'عضلات الروبوت', 'عين ترى', 'اللوحة تسمع', 'المصباح يومض',
  ];
  for (const d of DESC_TITLES)
    if (titleTxt.includes(d))
      err(f, `عنوان وصفي في <title>: «${d}» — ضع الاسم العلمي للدرس (انظر TERMS.md)`);

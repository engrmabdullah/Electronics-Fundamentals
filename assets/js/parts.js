...
(function () {
  ...
  const PARTS = {
    ...
    /* ─────────── حسّاس المسافة ─────────── */
    ultrasonic: {
      ar: 'حسّاس المسافة', en: 'Ultrasonic Sensor',
...
(function () {
  ...
  const TOOLS = {
    ...
    /* ─────────── كاوي اللحام ─────────── */
    'soldering-iron': {
      ar: 'كاوي اللحام', en: 'Soldering Iron',
...
(function () {
  ...
  const ROBOT = {
    ...
    /* ─────────── سائق المحرّك ─────────── */
    driver: {
      ar: 'سائق المحرّك', en: 'Motor Driver',
    ...
    /* ─────────── حسّاس تتبّع الخط ─────────── */
    'ir-sensor': {
      ar: 'حسّاس الخط', en: 'IR Line Sensor',
...
(function () {
  ...
  const EXTRA = {
    ...
    'capacitor-cer': {
      ar: 'مكثّف صغير', en: 'Small Capacitor',
...
(function () {
  ...
  const SENSORS = {
    ...
    /* ─────────── حسّاس الحرارة ─────────── */
    thermistor: {
      ar: 'حسّاس الحرارة', en: 'Thermistor',
    ...
    dht11: {
      ar: 'حسّاس حرارة ورطوبة رقمي', en: 'DHT11',
    ...
    /* ─────────── حسّاس الغاز والدخان ─────────── */
    gas: {
      ar: 'حسّاس الغاز والدخان', en: 'Gas Sensor',
...
(function () {
  ...
  const MORE = {
    ...
    /* ─────────── بطارية الهاتف ─────────── */
    lipo: {
      ar: 'بطارية الهاتف', en: 'Lithium Battery',

...
(function () {
  ...
  const MORE = {
    ...
    'short-circuit': {
      ...
      svg: `
        <path class="circ__wire" d="M60 40 H210 M250 40 H340 M340 40 V150 M340 150 H60 M60 150 V40 M250 40 V150"/>
        ${flow('M60 40 H210 M250 40 V150 M250 150 H60 M60 150 V40')}
        ${BATT}
        ${SW}
        ${lampDark(340, 95, 22, false)}
        <g class="circ__rays">
          <line x1="262" y1="78" x2="276" y2="68"/>
          <line x1="264" y1="95" x2="280" y2="95"/>
          <line x1="262" y1="112" x2="276" y2="122"/>
          <line x1="238" y1="78" x2="224" y2="68"/>
          <line x1="236" y1="95" x2="220" y2="95"/>
          <line x1="238" y1="112" x2="224" y2="122"/>
        </g>`,
      on: '⚠️ التيّار عاد دون أن يمرّ بالمصباح — السلك يسخن والبطارية تتلف',
